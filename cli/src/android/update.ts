...
export async function installGradlePlugins(
  ...
  if (!capacitorAndroidPath) {
    logFatal(
      `Unable to find node_modules/@lambda-capacitor/android/capacitor. Are you sure`,
      `@lambda-capacitor/android is installed? This file is currently required for Capacitor to function.`
    );
    return;
  }
